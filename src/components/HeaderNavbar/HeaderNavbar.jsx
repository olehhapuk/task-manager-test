...
export default function HeaderNavbar({signIn, signUp, home, products, about}) {
  return (
    <div>
      <nav
        id="header"
        ...
        <div className="w-full flex items-center justify-between mt-0 px-6 py-2">
          ...
          >
            <div className="auth flex items-center w-full md:w-full">
              ...
              <Link to="/login" className="bg-blue-600 text-gray-200  p-2 rounded  hover:bg-blue-500 hover:text-gray-100">
                {signUp}
              </Link>
            </div>
          </div>
